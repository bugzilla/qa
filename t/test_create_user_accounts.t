...
$sel->is_text_present_ok("Open a new Bugzilla account");
$sel->click_ok("link=Open a new Bugzilla account");
$sel->wait_for_page_to_load_ok(WAIT_TIME);
...
$sel->wait_for_page_to_load_ok(WAIT_TIME);
$sel->title_is("Bugzilla Main Page");
ok(!$sel->is_text_present("Open a new Bugzilla account"), "No link named 'Open a new Bugzilla account'");
