...
$sel->click_ok('//td[@title="From NEW to SUSPENDED"]//input[@type="checkbox"]');
$sel->click_ok('//td[@title="From SUSPENDED to NEW"]//input[@type="checkbox"]');
$sel->click_ok('//td[@title="From SUSPENDED to ASSIGNED"]//input[@type="checkbox"]');
...
$sel->click_ok('//td[@title="From IN_QA to NEW"]//input[@type="checkbox"]');
